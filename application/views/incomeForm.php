...
<body>
    ...
    if (!isset($edit)) {
        $id             = set_value('id');
        $people_id      = set_value('people_id');
        $date           = date('Y-m-d');
        $description    = set_value('description');
        $amount         = set_value('amount');
    } else {
        $id             = $getRow->id;
        $people_id      = $getRow->people_id;
        $date           = $getRow->date;
    ...
    <div class="appHeader">
        <div class="left">
            <a href="<?= base_url() ?>Home/income" class="headerButton goBack">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        <div class="form-group basic animated">
                            <div class="input-wrapper">
                                ...
                                <select class="form-control" name="people" id="people">
                                    ...
                                    <?php foreach ($people as $row) { ?>
                                        <option value="<?= $row->id ?>" <?php if ($row->id == $people_id) {
                                                                            echo 'selected';
                                                                        } ?>> <?= $row->name ?></option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" class="form-control" id="description" name="description" placeholder="Keterangan" value="<?= $description ?>">
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
                            <div class="input-wrapper">
                                ...
                                <input type="number" class="form-control" id="amount" name="amount" placeholder="Total" value="<?= $amount ?>">
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
    ...
    <div class="modal fade dialogbox" id="DialogBasicDelete" data-bs-backdrop="static" tabindex="-1" role="dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="btn-inline">
                        ...
                        <a href="<?= base_url() ?>Home/deleteIncome/<?= $id ?>" class="btn btn-text-primary">
