...
<body>
	...
	<div id="appCapsule">
		<br>
		<center>
			<a href="<?= base_url() ?>Home/addExpense" class="btn btn-primary me-1">+ Tambah Pengeluaran</a>
		</center>
		<br>
							...
							<a href="#" class="item" data-bs-toggle="modal" data-bs-target="#DialogIconedButtonInline<?= $row->id ?>">
								<div class="detail">
									...
									<div>
										...
										<p><?= number_format($row->amount, 0, ',', '.') ?> * <?= $row->total ?></p>
									</div>
								</div>
								<div class="right">
									<div class="price">Rp<?= number_format($row->total_amount, 0, ',', '.') ?></div>
								</div>
							</a>
					<?php }
					} ?>
	...
	<?php foreach ($getData as $row) { ?>
		<div class="modal fade dialogbox" id="DialogIconedButtonInline<?= $row->id ?>" data-bs-backdrop="static" tabindex="-1" role="dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-footer">
						<div class="btn-inline">
							...
							<a href="<?= base_url() ?>Home/editExpense/<?= $row->id ?>" class="btn btn-text-primary">
